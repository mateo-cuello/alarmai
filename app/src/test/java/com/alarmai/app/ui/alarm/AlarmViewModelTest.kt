...
class AlarmViewModelTest {
    ...
    fun setUp() {
        ...
        whenever(prefs.getGeminiModel()).thenReturn(GeminiModels.DEFAULT)
    ...
    fun testDismissAndTalk_UsesCachedBriefing() = runBlocking {
        ...
        verify(geminiAgentManager).reconstructSession(eq("fake-key"), eq(GeminiModels.DEFAULT), eq("cached prompt"), eq("cached briefing"))
